...
export function LoginForm() {
  ...
  return (
    <form
      ...
      className="space-y-6 rounded-2xl border border-sage/20 bg-white/80 p-8 shadow-xl shadow-sand/40 backdrop-blur"
    >
      <div>
        <p className="text-sm font-semibold text-sage">Welcome back</p>
        <h1 className="font-heading text-3xl text-night">Sign in to Elymica</h1>
        <p className="mt-2 text-sm text-olive">
          Enter your school code, email, and password to access your dashboard.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          className="w-full rounded-lg border border-sage/40 bg-white px-4 py-3 text-night outline-none transition focus:border-sage focus:ring-2 focus:ring-sage/40"
        />
      </div>
