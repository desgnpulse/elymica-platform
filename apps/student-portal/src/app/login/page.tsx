...
export const metadata: Metadata = {
  title: 'Sign in | Elymica Student Portal',
};
    ...
    <main className="relative min-h-screen bg-sand">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-6xl flex-col items-center justify-center px-6 py-16">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-2 font-heading text-4xl text-night">Education for 15+ African nations</h1>
        </div>
        <div className="w-full max-w-xl">
          <Suspense fallback={<div className="rounded-2xl border border-sage/20 bg-white/70 p-8 text-center text-olive">Preparing secure sign-in…</div>}>
            <LoginForm />
          </Suspense>
